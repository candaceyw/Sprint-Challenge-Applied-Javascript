...
1. What is the DOM?
    ...
    The Document Object Model is a programming interface for HTML and XML documents.The DOM represents a document with a logical tree. 

2. What is an event?

        Events are actions in a system that tells it how you can respond to them. 
